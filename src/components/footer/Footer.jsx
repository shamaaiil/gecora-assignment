...
function Footer() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="grid grid-cols-2 w-[80%] mx-auto pt-8">
        <div className="p-8">
          <img src="/public/img/logo.png" alt="" className="w-80" />
          <div className="py-8">
            <h2 className="text-3xl font-bold leading-tight p-2">
              Postaráme sa o vás
            </h2>
      ...
      <div className="grid grid-cols-2 w-[76%] mx-auto mt-10">
        <div>
      ...
      {/* Footer */}
      <footer className="mt-24 px-6 lg:px-12 pb-8">
        <div className="w-[80%] mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 text-gray-900">
            <div>
              <h4 className="font-semibold mb-2 text-4xl text-gray-900">
                Slovensko
              </h4>
            </div>
            <div>
              <h4 className="font-semibold mb-2 text-4xl">Česká republika</h4>
            </div>
            <div>
              <h4 className="font-semibold mb-2 text-4xl">România</h4>
            </div>
            <div>
              <h4 className="font-semibold mb-2 text-4xl">Polska</h4>
            </div>
          </div>
